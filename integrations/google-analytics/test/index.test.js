    ...
    describe('before loading', function() {
      ...
      describe('#initialize', function() {
        it("should require 'displayfeatures' if .doubleClick option is `true`", function() {
          ...
          analytics.page();
          analytics.deepEqual(toArray(window.ga.q[1]), [
            'require',
            'displayfeatures'
          ]);
        });
        ...
        it('should call window.ga.create with options', function() {
          ...
          if (window.location.hostname !== 'localhost')
            expectedOpts.cookieDomain = 'auto';
          analytics.initialize();
          analytics.page();
        ...
        it('should not send universal user id by default', function() {
          ...
          analytics.initialize();
          analytics.page();
          analytics.notDeepEqual(toArray(window.ga.q[1]), [
            'set',
            'userId',
            'baz'
          ]);
        ...
        it('should map custom dimensions & metrics using user.traits()', function() {
          ...
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(toArray(window.ga.q[2]), [
            'set',
            {
              metric1: 'John',
              metric2: 'Doe',
        ...
        it('should set metrics and dimensions that have dots but arent nested', function() {
          ...
          analytics
            .user()
            .traits({ 'name.first': 'John', 'name.last': 'Doe', age: 20 });
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(toArray(window.ga.q[2]), [
            'set',
    ...
    describe('after loading', function() {
      ...
      describe('#track', function() {
        ...
        it('should send a non-interaction option', function() {
          analytics.track(
            'event',
            {},
            { 'Google Analytics': { nonInteraction: 1 } }
          );
          analytics.called(window.ga, 'send', 'event', {
            eventCategory: 'All',
            eventAction: 'event',
        ...
        it('should map and set custom dimensions & metrics using track.properties() if setAllMappedProps is true', function() {
          ...
          analytics.track('Level Unlocked', {
            loadTime: '100',
            levelAchieved: '5',
            referrer: 'Google'
          });
      ...
      describe('ecommerce', function() {
        ...
        it('should send ecommerce data', function() {
          ...
          analytics.deepEqual(window.ga.args[1], [
          ...
          analytics.deepEqual(window.ga.args[2], [
            'ecommerce:addItem',
            {
              id: '780bc55',
              category: undefined,
          ...
          analytics.deepEqual(window.ga.args[3], [
            'ecommerce:addItem',
            {
              id: '780bc55',
              category: undefined,
  ...
  describe('Classic', function() {
    ...
    describe('before loading', function() {
      ...
      describe('#initialize', function() {
        ...
        it('should push the tracking id', function() {
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(window._gaq[0], [
            '_setAccount',
            settings.trackingId
          ]);
        });
        ...
        it('should set domain name', function() {
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(window._gaq[3], [
            '_setDomainName',
            settings.domain
          ]);
        });
        ...
        it('should set site speed sample rate', function() {
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(window._gaq[4], [
            '_setSiteSpeedSampleRate',
            settings.siteSpeedSampleRate
          ]);
        });
        ...
        it('should set enhanced link attribution', function() {
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(window._gaq[5], [
            '_require',
            'inpage_linkid',
        ...
        it('should set ignored referrers', function() {
          analytics.initialize();
          analytics.page();
          analytics.deepEqual(window._gaq[6], [
            '_addIgnoredRef',
            settings.ignoredReferrers[0]
          ]);
          analytics.deepEqual(window._gaq[7], [
            '_addIgnoredRef',
            settings.ignoredReferrers[1]
          ]);
        });
      });
    });
    ...
    describe('after loading', function() {
      ...
      describe('#page', function() {
        ...
        it('should send a page view', function() {
          analytics.page();
          analytics.called(window._gaq.push, [
            '_trackPageview',
            window.location.pathname
          ]);
        });
      ...
      describe('ecommerce', function() {
        ...
        it('should send simple ecommerce data', function() {
          ...
          analytics.deepEqual(
            ['_set', 'currencyCode', 'USD'],
            window._gaq.push.args[1][0]
          );
        ...
        it('should send ecommerce data', function() {
          ...
          analytics.deepEqual(window._gaq.push.args[1], [
            ['_addItem', 'af5ccd73', 'p-298', 'my product', undefined, 24.75, 1]
          ]);
          ...
          analytics.deepEqual(window._gaq.push.args[4], [['_trackTrans']]);
        });
        ...
        it('should fallback to revenue', function() {
          ...
          analytics.deepEqual(window._gaq.push.args[0], [
            ['_addTrans', 'f2ffee5c', undefined, 9, 2, 3, null, null, null]
          ]);
        });
      });
    });
